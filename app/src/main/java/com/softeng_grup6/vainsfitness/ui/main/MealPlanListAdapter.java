...
public class MealPlanListAdapter extends ArrayAdapter<MealPlan> {
    ...
    public MealPlanListAdapter(Context context, ArrayList<MealPlan> meals) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.add_from_plan_items, parent, false);
        }
        ...
        CheckBox check = (CheckBox) convertView.findViewById(R.id.select);
        String meal_items = "";
